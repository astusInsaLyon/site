    ...
    return {
      ...
      events: [
        ...
        },
        {
          name: "WEC",
          desc:
            "Un week-end en fin d'année, du canoë, un super camping : quoi de mieux ? C'est le dernier évènement de l'année scolaire et ça permet de vivre un dernier moment absolument fou tous ensemble !"
        }
      ]
    };
  }
